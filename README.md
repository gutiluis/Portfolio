...
[INFO] Flask based backend service for managing user portfolios and admin dashboards. Features are still being implemented and may change.
...
- Responsive Web Design: Ensuring the app renders well on all screen sizes and resolutions while ensuring good usability.

- Template Inheritence: Using Jinja2 to create reusable layouts (like a layout.html), which demonstrates DRY (Don't Repeat Yourself) coding principles.
